...
void initBuzzer()
{
	...
	GPIOA->AFRL |= GPIO_AFRL_AFSEL7_0;//selecting alternate function to be alternate function 1
	GPIOA->AFRL &= ~GPIO_AFRL_AFSEL7_1;//selecting alternate function to be alternate function 1
	GPIOA->AFRL &= ~GPIO_AFRL_AFSEL7_2;//selecting alternate function to be alternate function 1
	GPIOA->AFRL &= ~GPIO_AFRL_AFSEL7_3;//selecting alternate function to be alternate function 1
	...
	GPIOA->OTYPER |= GPIO_OTYPER_ODR7;// concerned this is incorrect if problems occour check value against stm file values to be sure
