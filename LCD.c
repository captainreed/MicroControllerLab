...
//GPIOB->MODER &= 0xAAFBFAFA; previous val
GPIOB->MODER &= 0xAAFB5A5A; //new val includes values to set bits for clock
//GPIOB->MODER |= 0xAA080A0A; previous val
GPIOB->MODER |= 0xAA085A5A;
